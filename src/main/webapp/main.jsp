...
<div class="preloading fadeIn">	   
		...
		<div class="right-menu">
				...
				<h3>현재 <%=user_id %>님이 로그인 중입니다.</h3>
				<a href="login.jsp" class="btn btn-primary-menu" target="blank" >로그인 </a>
				
				<a href="signup.jsp" class="btn btn-primary-menu" data-target="blank">회원가입</a>
  ...
  <span>G</span>
					        ...
					        <div class="lg-col-ttl2"> Project Title </div>
					...
					<div class="col-md-6 col-xs-12">
                       <div class="lg-col-bg2" >
                               <img src="img/d2.jpg" alt="" class="img-lg-col2">					   
                       </div>
	                </div>
		...
		<!--- WORK PRESENTATION --->
	            <div class="row">
					...
					<div class="col-md-6 col-xs-12">
                       <div class="lg-col-bg" >
					        <div class="lg-col-ttl2"> Project Date </div>
                            <div class="lg-col-wrt2"> Lorem ipsum dolor sit amet, 
	                ...
	                <div class="col-md-6 col-xs-12">
                       <div class="lg-col-bg" >
					        <div class="lg-col-ttl2"> The Challenge </div>
                            <div class="lg-col-wrt2"> Lorem ipsum dolor sit amet, 
							consectetur adipiscing elit, sed do eiusmod tempor incididunt 
							ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis 
							nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. </div>							
	                ...
	                <div class="col-md-6 col-xs-12">
                       <div class="lg-col-bg" >
					        <div class="lg-col-ttl2"> Project Role </div>
                            <div class="lg-col-wrt2"> Branding, Visual Identity, Web Design, Illustration</div>						
                       </div>
	                </div>					
					
	                <div class="col-md-6 col-xs-12">
                       <div class="lg-col-bg" >
					        <div class="lg-col-ttl2"> Our Approach </div>
                            <div class="lg-col-wrt2"> Lorem ipsum dolor sit amet, 
							consectetur adipiscing elit, sed do eiusmod tempor incididunt 
							ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis 
							nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. </div>							
	            ...
	            <div class="row">
	                <div class="col-md-4 col-xs-6">
                        <div class="lgs-bg" >					
					            <img src="img/logos/d2.jpg" alt="" class="img-prjct-lgs">
						</div>					
	                </div>
	            ...
	            <div class="row">
	                <div class="col-md-12 col-xs-12">
                       <div class="allprojects-lgs-bg" >
				           <a class="btn-allprojects" href="works.html" role="button">BACK TO ALL WORKS</a>				
                       </div>
	                </div>
				</div>								
