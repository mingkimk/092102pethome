...
<div class="preloading fadeIn">	 
		...
		<div class="right-menu">
				...
				<!-- <div> 
					<a class="btn btn-primary-menu" target="_blank" href="login.html">로그인 </a> //target"bank" 하면은 새창으로 열림 top은 그 창에서 다른 창으로 이동
					</div>  -->
			
					<a href="login.html" class="btn btn-primary-menu" target="blank" >로그인 </a>
				
				<a href="register.html" class="btn btn-primary-menu" data-target="blank">회원가입</a>
