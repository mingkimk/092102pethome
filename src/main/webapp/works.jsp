	            ...
	            <div class="row">
	                <div class="col-md-12">
                       <div class="works-hero-bg" >
					        <h1 class="fade-anime-top"> Partnerships </h1>
                            <h2 class="fade-anime-bottom"> Happy Brands </h2>						
                       </div>
	                </div>
				</div>
		<!--- THE END HERO HEADER --->				
		...
		<!--- WORK PAGE PROJECTS --->
			    <div class="row">
	                <div class="col-md-6 col-xs-12">
                        <div class="prjct-bg" >					
					            <a href="singleproject.html"> <img src="img/covers/d1.jpg" alt="" class="img-prjct-wrk"> </a>
					          <div class="prjct-wrt-left-wrk"> </div>
							  <div class="shw-cs2"> Project Title </div>
							  <div class="shw-cs4"> Branding, Identity </div>
							  <div class="shw-cs"> Based in City or Country </div>
						</div>					
	                </div>
	                ...
	                <div class="col-md-6 col-xs-12">
                        <div class="prjct-bg" >					
							  ...
							  <div class="shw-cs2"> Project Title </div>
							  <div class="shw-cs4"> Branding, Web Design </div>
							  <div class="shw-cs"> Based in City or Country </div>
						</div>
	                </div>
                </div>
			    ...
			    <div class="row">
	                <div class="col-md-6 col-xs-12">
                        <div class="prjct-bg" >					
					          ...
					          <div class="prjct-wrt-left-wrk"> </div>
							  <div class="shw-cs2"> Project Title </div>
							  <div class="shw-cs4"> Branding, Illustration </div>
							  <div class="shw-cs"> Based in City or Country </div>
						</div>					
	                </div>
	                ...
	                <div class="col-md-6 col-xs-12">
                        <div class="prjct-bg" >					
					          ...
					          <div class="prjct-wrt-right-wrk"> </div>
							  <div class="shw-cs2"> Project Title </div>
							  <div class="shw-cs4"> App Design, Web Design </div>
							  <div class="shw-cs"> Based in City or Country </div>
						</div>
	                </div>
                </div>			
			    ...
			    <div class="row">
	                <div class="col-md-6 col-xs-12">
                        <div class="prjct-bg" >					
					          ...
					          <div class="prjct-wrt-left-wrk"> </div>
							  <div class="shw-cs2"> Project Title </div>
							  <div class="shw-cs4"> Illustration </div>
							  <div class="shw-cs"> Based in City or Country </div>
						</div>					
	                </div>
	                ...
	                <div class="col-md-6 col-xs-12">
                        <div class="prjct-bg" >					
					          ...
					          <div class="prjct-wrt-right-wrk"> </div>
							  <div class="shw-cs2"> Project Title </div>
							  <div class="shw-cs4"> Branding </div>
							  <div class="shw-cs"> Based in City or Country </div>
						</div>
	                </div>
                </div>
			    ...
			    <div class="row">
	                <div class="col-md-6 col-xs-12">
                        <div class="prjct-bg" >					
					          ...
					          <div class="prjct-wrt-left-wrk"> </div>
							  <div class="shw-cs2"> Project Title </div>
							  <div class="shw-cs4"> Branding, Social Marketing </div>
							  <div class="shw-cs"> Based in City or Country </div>
						</div>					
	                </div>
			    ...
			    <div class="row">
	                <div class="col-md-6 col-xs-12">
                        <div class="prjct-bg" >					
					          ...
					          <div class="prjct-wrt-left-wrk"> </div>
							  <div class="shw-cs2"> Project Title </div>
							  <div class="shw-cs4"> Branding, App Design </div>
							  <div class="shw-cs"> Based in City or Country </div>
						</div>					
	                </div>
	            ...
	            <div class="row">
                       <div class="footer-bg" >
					      <div class="col-md-4 col-xs-12">
						    ...
						    <a href="mailto:hello@yoursite"> <div class="ftr-lnk"> hello@yoursite </div>
                            </div>
					      ...
					      <div class="col-md-4 col-xs-6">
							...
							<div class="ftr-lnk-on"> Works </div>
